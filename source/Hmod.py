class Specie:
    def __init__(self, specie_id, compartment, val, fixed, specie_min, specie_max, isres):
        self.id = specie_id
...
class Compartment:
    def __init__(self, compartment_id, val, fixed, compartment_min, compartment_max, isres):
...
class Hmod:
    ...
    def add_specie(self, specie_id, compartment, val, fixed, specie_min, specie_max, isres):
        self.species.append(Specie(specie_id, compartment, val, fixed, specie_min, specie_max, isres))

    def add_compartment(self, compartment_id, val, fixed, compartment_min, compartment_max, isres):
        self.compartments.append(Compartment(compartment_id, val, fixed, compartment_min, compartment_max, isres))
    ...
    def add_rate_rule(self, rate_rule_id, val, rate_rule_min, rate_rule_max, isres):
        self.rate_rules.append(RateRule(rate_rule_id, val, rate_rule_min, rate_rule_max, isres))
    ...
    def is_valid(self):
        ...
        for count, cmp in enumerate(species_compartments):
            if cmp not in compartments_ids:
                return f"Error in species {count + 1} compartments. " \
