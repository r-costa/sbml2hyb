...
Can be easily installed using the executable file ([.exe](https://github.com/rs-costa/sbml2hyb/raw/main/exe/SBML2HYB.exe)) and double-click. Please make sure to check that you create a folder containing the executable file and the logo.
